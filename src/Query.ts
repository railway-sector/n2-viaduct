...
import { dateTable, viaductLayer, viaductLayerStatus4 } from "./layers";
...
interface layersRevitVisibilityType {
  layers: [SceneLayer, SceneLayer?, SceneLayer?, FeatureLayer?];
}
...
interface queryBuildingLayersType {
  ...
  layers:
    | [SceneLayer, SceneLayer?, SceneLayer?, SceneLayer?, SceneLayer?]
    | any;
  status?: number;
  statusState?: any;
  statusField?: any;
