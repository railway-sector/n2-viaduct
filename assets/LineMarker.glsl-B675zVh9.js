import{xD as te,HY as ie,HZ as re,Gz as ae,H_ as se,H$ as oe,GD as o,HR as ne,H6 as ce,HQ as le,GC as y,I0 as pe,I1 as de,Ha as N,GB as he,GE as ve,GF as ue,Hw as me,GH as fe,I2 as H,I3 as R,I4 as Se,I5 as ge,Hb as Pe,fW as ye,qG as _e,jH as we,qI as xe,_ as $e,qK as D,GJ as U,GK as ze,GL as E,qL as M,GN as be,GO as Ve,GQ as ke,I6 as Oe,I7 as q,I8 as B,I9 as Te,Ia as We,Ib as Ce,$ as d,a2 as De,Hd as Le,GS as m,fv as Me,GU as L,Hg as je,Ic as Q,t6 as Ie,HI as Fe,Id as Ae,GV as Ge,cM as Y,kt as Ne,fS as K,v as J,Ie as He}from"./index-DGCQOAm6.js";function Z(r){const e=new te,{space:a,anchor:t,hasTip:_,hasScreenSizePerspective:w}=r,f=a===2,V=a===1;e.attributes.add("position","vec3"),e.vertex.inputs.add("position",()=>"position"),e.include(ie,r),e.include(re,r);const{vertex:i,fragment:g,varyings:S}=e;ae(i,r),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),S.add("vColor","vec4"),S.add("vpos","vec3",{invariant:!0}),S.add("vUV","vec2"),S.add("vSize","float"),_&&S.add("vLineWidth","float"),i.uniforms.add(new se("nearFar",({camera:c})=>c.nearFar),new oe("viewport",({camera:c})=>c.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
...
return abs(cos) > 0.001 && t > 0.0;
  ...
  `)),pe(i),e.include(de),i.main.add(o`
    ...
    }`),g.include(he,r),e.include(ve,r),g.include(ue),g.uniforms.add(new me("intrinsicColor",({color:c})=>c),new fe("tex",({markerTexture:c})=>c)).constants.add("texelSize","float",1/H).code.add(o`float markerAlpha(vec2 samplePos) {
samplePos += vec2(0.5, -0.5) * texelSize;
float sdf = texture(tex, samplePos).r;
float pixelDistance = sdf * vSize;
pixelDistance -= 0.5;
return clamp(0.5 - pixelDistance, 0.0, 1.0);
}`),_&&(e.include(R),g.constants.add("relativeMarkerSize","float",Se/H).constants.add("relativeTipLineWidth","float",ge).code.add(o`
