import{Kw as be,Ks as we,KO as De,Iw as f,JI as w,KB as Ve,Ix as B,It as r,c2 as z,y1 as ee,Kv as xe,Jm as E,cU as te,cS as A,hk as F,KP as ye,hM as ie,JG as ne,I_ as S,g0 as _,cR as v,KQ as se,Al as ae,n as o,mS as re,hj as Le,s3 as Ee,cV as Se,d4 as le,fb as oe,hh as Ce,Kt as Me,yf as Ae,IY as $e,JQ as Re,Is as H,g2 as Te,r4 as ce,r6 as he,_ as de,g3 as Ie,g6 as K,qD as j,ak as c,an as q,jR as pe,g4 as ue,cP as Oe,cT as O,lH as Ue,J9 as je,lJ as ze,KR as qe,II as V,oi as Ne,oj as G,KS as We,mQ as Be,KT as $,KU as Fe,x4 as J,r$ as He,vM as Ke,s0 as Ge,s1 as Je,s2 as ke,s4 as Qe,am as C,KV as Xe,o0 as k}from"./index-DlAtmYmo.js";import{t as Ye}from"./VisualElement-CMPQzDtq.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new B("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new E("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=F(D),d)),new ye("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/F(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
...
vec4 color = vec4(0.0);`),t.heightManifoldEnabled){n.uniforms.add(new S("angleCutoff",s=>M(s)),new E("heightPlane",(s,a)=>me(s.heightManifoldTarget,s.renderCoordsHelper.worldUpAtPosition(s.heightManifoldTarget,u),a.camera.viewMatrix)));const i=t.spherical?r`normalize(globalOrigin - pos)`:r`heightPlane.xyz`;n.main.add(r`
      ...
      color = max(color, heightManifoldColor * heightManifoldAlpha);`)}return t.pointDistanceEnabled&&(n.uniforms.add(new S("angleCutoff",i=>M(i)),new E("pointDistanceSphere",(i,s)=>Ze(i,s))),n.main.add(r`float pointDistanceSphereDistance = sphereDistancePixels(pointDistanceSphere, pos);
