import{IG as be,IC as we,IY as De,GG as f,HS as w,IL as Ve,GH as W,GD as r,bX as q,xD as ee,IF as xe,Hw as y,cN as te,cL as A,ha as B,IZ as Le,hC as ie,HQ as ne,H8 as S,fS as _,cK as v,I_ as se,zI as ae,v as o,mr as re,h9 as Ee,rF as ye,cO as Se,cZ as le,f1 as oe,h7 as Ce,ID as Me,xR as Ae,H6 as $e,H_ as Re,GC as F,fU as Te,qG as ce,qI as he,_ as de,fV as Ie,fY as G,qd as j,$ as c,a2 as z,jH as pe,fW as ue,cI as Oe,cM as O,lg as Ue,Hj as je,li as qe,I$ as ze,GS as V,nT as Ne,nU as J,J0 as He,mp as We,J1 as $,J2 as Be,wG as k,rB as Fe,vm as Ge,rC as Je,rD as ke,rE as Xe,rG as Ze,a1 as C,J3 as Qe,nB as X}from"./index-CIW1gNC9.js";import{t as Ye}from"./VisualElement-DrjeOZ32.js";function fe(t,e){const n=t.fragment;n.include(be),t.include(we),n.include(De),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new Ve("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
...
return abs(dist);
}`),t.spherical){const i=(a,l,p)=>_(a,l.heightManifoldTarget,p.camera.viewMatrix),s=(a,l)=>_(a,[0,0,0],l.camera.viewMatrix);n.uniforms.add(new y("heightManifoldOrigin",(a,l)=>(i(u,a,l),s(D,l),te(D,D,u),A(d,D),d[3]=B(D),d)),new Le("globalOrigin",a=>s(u,a)),new f("cosSphericalAngleThreshold",(a,l)=>1-Math.max(2,ie(l.camera.eye,a.heightManifoldTarget)*l.camera.perRenderPixelRatio)/B(a.heightManifoldTarget))),n.code.add(r`float globeDistancePixels(float posInGlobalOriginLength) {
