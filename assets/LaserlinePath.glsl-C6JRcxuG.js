import{JD as Pe,Jz as be,K2 as we,Hx as f,IO as w,JF as De,Hy as W,Hu as r,fp as z,x8 as Y,JC as Ve,Ir as C,g8 as ee,g9 as R,hR as F,K3 as xe,fS as te,IM as ie,I4 as M,gP as m,g$ as v,K4 as ne,zs as se,K as o,mF as ae,hQ as Ee,i9 as ye,ga as Le,dz as re,fY as le,hO as Se,JA as Ce,xm as Me,I2 as Ae,IW as $e,Ht as B,gR as Re,HA as oe,HB as ce,_ as he,pe as Te,g_ as G,ia as q,ag as c,al as j,jZ as de,jX as pe,dE as Ie,dy as I,lr as Oe,Id as qe,lw as Ue,K5 as ze,HP as V,JJ as je,JK as K,K6 as Ne,mD as He,K7 as T,K8 as We,i4 as Fe,va as Be,i6 as Ge,i7 as Ke,i8 as Je,ib as ke,ah as A,K9 as Xe,pN as J}from"./index-BtZUiJlQ.js";import{t as Qe}from"./VisualElement-C0DS-B3e.js";function ue(t,e){const n=t.fragment;n.include(Pe),t.include(be),n.include(we),n.uniforms.add(new f("globalAlpha",i=>i.globalAlpha),new w("glowColor",i=>i.glowColor),new f("glowWidth",(i,s)=>i.glowWidth*s.camera.pixelRatio),new f("glowFalloff",i=>i.glowFalloff),new w("innerColor",i=>i.innerColor),new f("innerWidth",(i,s)=>i.innerWidth*s.camera.pixelRatio),new De("depthMap",i=>i.depth?.attachment),new W("normalMap",i=>i.normals)),n.code.add(r`vec4 premultipliedColor(vec3 rgb, float alpha) {
